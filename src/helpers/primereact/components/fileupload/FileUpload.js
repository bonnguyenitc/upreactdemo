...
var FileUpload = exports.FileUpload = function (_Component) {
    ...
    _createClass(FileUpload, [{
                ...
                for (var _iterator = files[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (!this.isFileSelected(file)) {
                        if (this.validate(file)) {
                            ...
                            this.setState({ files: [].concat(_toConsumableArray(this.state.files), [file]) }, function () {
        ...
        value: function renderChooseButton() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { ref: function ref(el) {
                    ...
                    }, id: 'btn-input',type: 'file', onChange: this.onFileSelect, onFocus: this.onFocus, onBlur: this.onBlur,
        ...
        value: function renderFiles() {
            var _this5 = this;
            var fillAdd = _react2.default.createElement(
                'div',
                { id : 'add'},
                _react2.default.createElement(_Button.Button, { type: 'button', icon: 'fa fa-plus'})
            );
            return _react2.default.createElement(
                'div',
                { className: 'ui-fileupload-files' },
                this.state.files.map(function (file, index) {
                    var previewIMG = _this5.isImage(file) ? _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('img', { id: 'imgrevi',alt: file.name, role: 'presentation', src: file.objectURL, width: _this5.props.previewWidth })
                    ) : null;
                    var previewVideo = _this5.isImage(file) === false? _react2.default.createElement(
                        'div',
                        { id:'thumb' },
                    ) : null;
                    ...
                    var removeButton = _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(_Button.Button, { type: 'button', icon: 'fa fa-window-close', onClick: function onClick() {
